...
u64 pt_get_and_update_ip(u8 *packet, u32 len, u64 *last_ip)
{
    u64 ip;
...
//#define DEBUG_PACKET
u64 hash_func(u64 hash, char * str, size_t num){
...
void pt_parse_packet(char *buffer, size_t size, int dfd, int rfd){
